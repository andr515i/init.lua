local c = require("user.themes.chromognomev2.palette")
...
theme.set_highlights = function()
    ...
    hl(0, "QuickFixLine", { fg = c.sun, bg = c.base01, sp = "NONE" })
    ...
    -- Neo-tree
    hl(0, "NeoTreeNormal", { fg = c.base05, bg = c.darker_black })
    hl(0, "NeoTreeNormalNC", { fg = c.base05, bg = c.darker_black })
    hl(0, "NeoTreeEndOfBuffer", { fg = c.darker_black, bg = c.darker_black })
    hl(0, "NeoTreeWinSeparator", { fg = c.darker_black, bg = c.darker_black })
    hl(0, "NeoTreeCursorLine", { bg = c.black2 })

    hl(0, "NeoTreeDirectoryName", { fg = c.folder_bg, bg = "NONE" })
    hl(0, "NeoTreeDirectoryIcon", { fg = c.purple, bg = "NONE" })
    hl(0, "NeoTreeRootName", { fg = c.base05, bg = "NONE", bold = true })

    hl(0, "NeoTreeTitleBar", { fg = c.white, bg = c.purple, bold = true })
    hl(0, "NeoTreeFloatTitle", { fg = c.white, bg = c.purple, bold = true })
    hl(0, "NeoTreeFloatBorder", { fg = c.purple, bg = c.darker_black })
end
